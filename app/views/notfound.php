            ...
            xhr.onload = function() {
                if (xhr.status === 200) {
                    ...
                    if (response.loggedIn) {
                        ...
                        links += "<h1> se asi ztratil. Ale neboj i tak pro tebe něco máme.</h1> <br> <a href='/writertest'>Domů</a> <a href='/writertest/account/'>Účet</a>";
                        ...
                        links += " <a href='categories/'>Seznam kategorií</a> <a href='/writertest/logout/'>Odhlásit</a>";
